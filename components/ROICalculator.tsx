        ...
        <Reveal>
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-6xl font-display font-black text-white uppercase tracking-tighter mb-6">
              The <span className="text-brand-400">ROI</span> Architect
            </h2>
            <p className="text-slate-400 max-w-2xl mx-auto font-light text-lg">
              Stop looking at a website as an expense. Calculate the exact revenue lift our AI systems generate for your specific business model.
            </p>
          </div>
        </Reveal>
          ...
          <Reveal delay={100}>
            <div className="glass-panel p-10 rounded-[3rem] border border-slate-800 bg-slate-950/50 space-y-8">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-bold text-white uppercase tracking-widest">Business Variables</h3>
              </div>

              <div className="space-y-6">
                <div>
                  <div className="flex justify-between mb-2">
                    <label className="text-xs font-bold text-slate-500 uppercase tracking-widest">Monthly Traffic</label>
                    <span className="text-brand-400 font-mono font-bold">{traffic.toLocaleString()} Visitors</span>
                  </div>
                  <input 
                ...
                <div>
                  <div className="flex justify-between mb-2">
                    <label className="text-xs font-bold text-slate-500 uppercase tracking-widest">Current Booking Rate</label>
                ...
                <div>
                  <div className="flex justify-between mb-2">
                    <label className="text-xs font-bold text-slate-500 uppercase tracking-widest">Avg. Client Value</label>
                ...
                <div>
                  <div className="flex justify-between mb-2">
                    <label className="text-xs font-bold text-slate-500 uppercase tracking-widest">Monthly Admin Hours (Manual Work)</label>
                    <span className="text-brand-400 font-mono font-bold">{adminHours} hours</span>
                  </div>
                  <input 
              ...
              <div className="pt-6 border-t border-slate-800">
                <div className="flex items-start gap-4 text-slate-400 text-sm italic font-light">
                   ...
                   <p>Calculations based on real-world data from our active AI implementations. Every business varies, but the logic remains: ownership beats rental.</p>
                </div>
              </div>
            </div>
          </Reveal>
            ...
            <div className="grid gap-6">
              ...
              <div className="p-10 rounded-[3rem] bg-gradient-to-br from-brand-500 to-brand-700 text-slate-950 shadow-[0_0_50px_rgba(14,165,233,0.3)]">
                <div className="flex justify-between items-start mb-6">
                  <TrendingUp size={40} />
                  <span className="px-4 py-1 bg-slate-950 text-white rounded-full text-[10px] font-black uppercase tracking-widest">Monthly Revenue Lift</span>
                </div>
                <div className="text-6xl font-black tracking-tighter mb-2">
                  £{results.revenueLift.toLocaleString()}
                </div>
                <p className="font-medium opacity-80 leading-relaxed max-w-sm">
                  Estimated growth by upgrading from a static template to an AI-orchestrated revenue engine.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="glass-panel p-8 rounded-[2.5rem] border border-slate-800 bg-slate-900/40">
                  <div className="flex items-center gap-2 text-slate-500 mb-2">
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-widest">Efficiency Bonus</span>
                  </div>
                  <div className="text-2xl font-black text-white">£{results.adminSavings}</div>
                  <p className="text-xs text-slate-500 mt-1 font-light italic">Saved in manual labor / month</p>
                </div>

                <div className="glass-panel p-8 rounded-[2.5rem] border border-slate-800 bg-slate-900/40">
                  <div className="flex items-center gap-2 text-slate-500 mb-2">
                    <Clock size={16} className="text-brand-400" />
                    <span className="text-[10px] font-bold uppercase tracking-widest">Investment Payback</span>
                  </div>
                  <div className="text-2xl font-black text-white">{results.breakEvenDays} Days</div>
                  <p className="text-xs text-slate-500 mt-1 font-light italic">Est. time to break even</p>
                </div>
              </div>

              <div className="p-8 rounded-[2.5rem] border border-slate-800 bg-slate-950/80 flex items-center justify-between">
                <div>
                  <div className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1">Total Monthly Competitive Edge</div>
